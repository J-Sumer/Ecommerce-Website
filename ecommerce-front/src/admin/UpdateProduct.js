...
// values are getting wiped off at some point
...
//                 <input autoFocus onChange={handleChange('name')} type="text" className="form-control" value={name} />
//             </div>
...
//     return (
//         <Layout title="Update product" description={`update product details`} className="container mb-5">
//             <div className="row">
